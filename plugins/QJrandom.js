  ...
  .then((_0x58577b) => {
    ...
    smd(
      ...
      async (_0x29f880, _0x547438) => {
        try {
          ...
          if (!_0x225090) {
            return await _0x29f880.reply("*Not found, dummy!* 😤");
          }
          ...
          _0x29f880.error(
            _0xf96be8 + "\n\nCommand: drive",
            _0xf96be8,
            _0xf96be8.message || "*ERROR! Couldn't handle the request, idiot!* 😤"
          );
        }
      }
    );
    ...
    async function _0x5aae0a(_0x5024e5, _0x48ad67) {
      ...
      if (!_0x5024e5 || !_0x5024e5.match(/drive\.google/i)) {
        throw "Invalid URL, you simpleton!";
      }
      _0xbbdee3 = (_0x5024e5.match(/\/?id=(.+)/i) ||
        _0x5024e5.match(/\/d\/(.*?)\//))[1];
      if (!_0xbbdee3) {
        throw "ID Not Found, are you blind?!";
      }
      ...
      if (!_0xffc830) {
        throw "URL Not Found! Are you sure about this?";
      }
      let _0x372123 = await _0x48ad67(_0xffc830);
      if (_0x372123.status !== 200) {
        throw "Request Not Completed! Get it together!";
      }
      return {
        downloadUrl: _0xffc830,
        fileName: _0x1b4935,
